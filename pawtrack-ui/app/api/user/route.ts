...
export async function GET(request: NextRequest) {
  try {
    ...
    const clinicIds = searchParams.getAll("clinicIds");
    const roleIds = searchParams.getAll("roleIds");
    ...
    params.append("paginationRequired", "true");
    ...
    const apiUrlWithParams = `${apiUrl}/api/User?${params.toString()}`;
