...
import { RefillRequests } from "./refill-requests"
...
function PrescriptionTable({ prescriptions, onViewPrescription }) {
  return (
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm overflow-hidden">
              ...
              <tr key={prescription.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  <Button
                    variant="secondary"
                    size="sm"
                    className={prescription.status === "Pending" ? "theme-button text-white" : "theme-button-outline"}
                    onClick={() => onViewPrescription(prescription)}
                  >
                    {prescription.status === "Pending" ? "Review" : "View"}
                  </Button>
                </td>
              </tr>
            ))}
      ...
      {/* Pagination */}
      <div className="px-6 py-4 bg-gray-50 dark:bg-slate-700 flex justify-between items-center">
        <div className="text-sm text-gray-700 dark:text-gray-300">
          Showing 1-5 of {prescriptions.length} prescriptions
        </div>
        <div className="flex items-center space-x-2">
          <Button variant="outline" size="sm" className="theme-button text-white">
            1
          </Button>
          <Button variant="outline" size="sm" className="bg-white dark:bg-slate-800 hover:theme-button-outline">
            2
          </Button>
          <Button variant="outline" size="sm" className="bg-white dark:bg-slate-800 hover:theme-button-outline">
            3
