...
import StockAdjustmentDetailsSheet from "./stock-adjustment-details-sheet"
...
export default function StockAdjustmentTab({ clinicId }: Props) {
            ...
            cell: ({ row }) => (
                <div className="flex gap-2 justify-center">
                    <Button
                        ...
                        onClick={(e) => {
                            e.stopPropagation()
                            setSelectedProductId(row.original.product?.id)
                            setOpenDetailsSheet(true)
                        }}
