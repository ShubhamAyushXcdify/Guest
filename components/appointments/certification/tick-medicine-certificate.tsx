...
export default function TickMedicineCertificate({ appointmentId, patientId, onClose, readOnly = false }: TickMedicineCertificateProps) {
    ...
    try {
      ...
      if (certificateData) {
        ...
        toast({
          ...
          description: "Tick Medicine Certificate updated successfully.",
        });
      } else {
        ...
        toast({
          ...
          description: "Tick Medicine Certificate saved successfully.",
        });
      }
    } catch (error: any) {
      toast({
