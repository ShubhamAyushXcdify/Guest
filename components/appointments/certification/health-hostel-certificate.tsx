...
export default function HealthHostelCertificate({ appointmentId, patientId, onClose }: HealthHostelCertificateProps) {
  ...
  const handleGenerateCertificate = async () => {
    ...
    toast({
      ...
      description: "Health Certificate for Hostel has been generated successfully.",
    })
  }
