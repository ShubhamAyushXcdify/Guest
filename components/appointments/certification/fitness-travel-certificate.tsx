...
export default function FitnessTravelCertificate({ appointmentId, patientId, onClose, readOnly = false }: FitnessTravelCertificateProps) {
  ...
  const renderCertificatePreview = () => {
    ...
    const certificationText = "This is to certify that I have personally examined the below mentioned pet and found that the pet is fit for travel and meets all transportation requirements. The pet has been thoroughly examined and is free from any contagious diseases or health conditions that would prevent safe travel."
      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-8 max-w-4xl mx-auto shadow-lg">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-blue-600 underline decoration-2 underline-offset-4">
            FITNESS CERTIFICATE FOR TRAVELLING
          </h2>
        </div>
