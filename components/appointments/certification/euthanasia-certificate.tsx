...
export default function EuthanasiaCertificate({ appointmentId, patientId, onClose }: EuthanasiaCertificateProps) {
  ...
  const handleGenerateCertificate = async () => {
    ...
    toast({
      ...
      description: "Euthanasia Certificate has been generated successfully.",
    })
  }
