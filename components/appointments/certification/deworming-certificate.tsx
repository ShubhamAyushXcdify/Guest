...
export default function DewormingCertificate({ appointmentId, patientId, onClose }: DewormingCertificateProps) {
  ...
  const handleGenerateCertificate = async () => {
    ...
    toast({
      ...
      description: "Deworming Certificate has been generated successfully.",
    })
  }
