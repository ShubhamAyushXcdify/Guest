...
export default function AllergyModal({ open, onClose, patientId, appointmentId }: AllergyModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Allergy Desensitization Registration Data:', {
        ...formData,
        patientId,
        appointmentId,
        procedureCode: "THEALL009"
      })
      
      toast.success("Allergy desensitization procedure registered successfully!")
      ...
      toast.error("Failed to register allergy desensitization procedure")
    }
  }
