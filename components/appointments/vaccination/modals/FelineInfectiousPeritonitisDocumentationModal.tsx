...
export default function FelineInfectiousPeritonitisDocumentationModal({ open, onClose, vaccine, clinicId }: FelineInfectiousPeritonitisDocumentationModalProps) {
